...
|---|---|---|---|---|
| **Locked bets** (ML/Total) | 389-335 | **53.7%** | — | -12.14u · CLV -3.07% |
| NRFI/YRFI forced calls | 191-180 | **51.5%** | 59.2% | 🔴 behind its own number · ⚠️ below 53% naive baseline |
| HR board (top 10 daily) | 43-217 | **16.5%** | 22.8% | 🔴 behind its own number |
| Player props (all tiers) | 6532-7107 | **47.9%** | 53.0% | 🔴 behind its own number · CLV +0.35% |
| &nbsp;&nbsp;↳ props · tier A (HR, pitcher K) | 277-274 | **50.3%** | 58.0% | 🔴 behind its own number |
| &nbsp;&nbsp;↳ props · tier B (hits, batter K) | 2246-2106 | **51.6%** | 57.7% | 🔴 behind its own number |
| &nbsp;&nbsp;↳ props · tier C (RBI, H+R+RBI) | 3996-4710 | **45.9%** | 50.4% | 🔴 behind its own number |
...
**Model A: 389-335  ·  54% win  ·  -12.14u  ·  -1.7% ROI  ·  avg CLV -3.07%**
...
|---|---|---|---|---|---|---|
| High | 195 | 100 | 95 | 51% | 64% | -12% |
| Medium | 66 | 36 | 30 | 55% | 56% | -1% |
| Low | 38 | 17 | 21 | 45% | 54% | -9% |
| Coin flip | 72 | 38 | 34 | 53% | 53% | -0% |
| **All** | **371** | **191** | **180** | **51%** | **59%** | **-8%** |

YRFI share of calls: **239/371 (64%)** — hitting 49%.

**Naive baseline check.** First innings were scoreless in **52.8%** of these games, so always calling NRFI scores **52.8%**. The model scores **51.5%**.
...
- listed and graded: **260**
- homered: **43** · model expected **59.4**
- actual rate **16.5%** vs predicted **22.8%** (**-6.3%**)

### Prop divergence board

| Tier | Market | n | Hit | Miss | Hit% | Model said | Gap |
|---|---|---|---|---|---|---|---|
| A | Ks (P) | 551 | 277 | 274 | 50% | 58% | -8% |
| B | Hits | 4352 | 2246 | 2106 | 52% | 58% | -6% |
| C | H+R+RBI | 4353 | 2207 | 2146 | 51% | 56% | -5% |
| C | RBI | 4353 | 1789 | 2564 | 41% | 45% | -4% |
| **All** | | **13639** | **6532** | **7107** | **48%** | **53%** | **-5%** |
...
| PLAY | 229-176 | +4.59u | +1.1% | -7.4% to +9.7% | ⚪ inconclusive |
...
| Total | 53-65 | -13.96u | -11.8% | -29.8% to +7.6% | ⚪ inconclusive |
| Run Line | 42-48 | -2.11u | -2.3% | -24.3% to +20.2% | ⚪ inconclusive |
| Moneyline | 231-165 | +6.57u | +1.7% | -7.0% to +10.5% | ⚪ inconclusive |

### By price band

| Segment | Record | Units | ROI | 95% CI | Verdict |
|---|---|---|---|---|---|
| fav -121 to -160 | 88-82 | -18.93u | -11.1% | -24.0% to +1.9% | ⚪ inconclusive |
| dog +120 or longer | 19-34 | -5.19u | -9.8% | -40.8% to +21.8% | ⚪ inconclusive |
| heavy fav past -160 | 80-45 | -3.30u | -2.6% | -15.7% to +9.5% | ⚪ inconclusive |
| pickem -120 to -100 | 109-102 | -3.67u | -1.7% | -14.1% to +10.8% | ⚪ inconclusive |
...
| 7.0–7.9 | 114 | 59-55 | -2.11u | -1.9% |
| 8.0–8.9 | 85 | 54-31 | +11.90u | +14.0% |
| 9.0–10.9 | 206 | 116-90 | -5.20u | -2.5% |

> Rank correlation between score band and ROI: **+0.70** (+1.00 = ROI rises perfectly with score).

> Below score 7.0: **-23.93u over 255 bets (-9.4%)**. At 7.0 and above: **+4.59u over 405 bets (+1.1%)**. The sign flips at exactly the PLAY threshold.
...
> 28 picks were locked on a LATE core run (the midnight slot was dropped and the work was done hours later). They count in the W-L record but are excluded from CLV below, because a pick taken at noon cannot be compared to a closing line the same way one taken at midnight can.
...
| Market | Pick | Line | Price | Score | CLV | Result |
|---|---|---|---|---|---|---|
| Moneyline | Tampa Bay Rays ML | — | -126 | 9.5 | — | ❌ -1.00u |
| Moneyline | Los Angeles Dodgers ML | — | -300 | 9.5 | — | ✅ +0.33u |
| F5 Total | F5 Over 3.5 | 3.5 | -152 | 9.5 | — | ✅ +0.66u |
| Total | Under 9.0 | 9.0 | -105 | 7.1 | — | ❌ -1.00u |
| Moneyline | Milwaukee Brewers ML | — | -108 | 7.0 | — | ❌ -1.00u |

**Recommended props** (0 of 390 priced cleared the gate)
...
| Player | Mkt | Call | Line | Price | Model | Actual | Result |
|---|---|---|---|---|---|---|---|
| Heriberto Hernandez | Hits | Under | 1.5 | -271 | 88% | 1 | ✅ |
| Carlos Narvaez | RBI | Under | 0.5 | -372 | 85% | 0 | ✅ |
| Jake Mangum | RBI | Under | 0.5 | -252 | 77% | 1 | ❌ |
| Jakob Marsee | RBI | Under | 0.5 | -293 | 79% | 0 | ✅ |
| Jac Caglianone | Hits | Over | 0.5 | -258 | 76% | 2 | ✅ |
| Victor Mesa Jr. | RBI | Under | 0.5 | -257 | 76% | 0 | ✅ |
| Vladimir Guerrero Jr. | Hits | Under | 1.5 | -253 | 74% | 0 | ✅ |
| Griffin Conine | RBI | Under | 0.5 | -266 | 75% | 0 | ✅ |

*Legs: **18-7**. A 25-leg parlay of these would NOT have cashed — every leg must land.*

**NRFI / YRFI forced calls**

| Game | Call | Confidence | Model | Market | Result |
|---|---|---|---|---|---|
| San Francisco Giants @ Pittsburgh Pirates | **YRFI** | High | 65% | 53% | ✅ |
| Chicago White Sox @ Houston Astros | **YRFI** | High | 67% | 48% | ✅ |
| Milwaukee Brewers @ Chicago Cubs | **YRFI** | High | 60% | 50% | ❌ |
| Tampa Bay Rays @ Texas Rangers | **NRFI** | High | 61% | 52% | ✅ |
| Athletics @ Seattle Mariners | **YRFI** | High | 60% | 45% | ✅ |
| Boston Red Sox @ Baltimore Orioles | **NRFI** | Medium | 58% | 53% | ❌ |
| Miami Marlins @ Kansas City Royals | **NRFI** | Low | 53% | 49% | ❌ |
| Toronto Blue Jays @ Cleveland Guardians | **NRFI** | Coin flip | 52% | 55% | ✅ |
| St. Louis Cardinals @ Los Angeles Dodgers | **NRFI** | Coin flip | 51% | 56% | ❌ |

**HR board — top 10**

| # | Player | Game | P(HR) | Result |
|---|---|---|---|---|
| 1 | Yordan Alvarez | Chicago White Sox @ Houston Astros | 23% | ❌ |
| 2 | Pete Crow-Armstrong | Milwaukee Brewers @ Chicago Cubs | 20% | ✅ |
| 3 | Munetaka Murakami | Chicago White Sox @ Houston Astros | 19% | ❌ |
| 4 | Christian Walker | Chicago White Sox @ Houston Astros | 18% | ❌ |
| 5 | Jeremy Peña | Chicago White Sox @ Houston Astros | 18% | ❌ |
| 6 | Junior Caminero | Tampa Bay Rays @ Texas Rangers | 17% | ❌ |
| 7 | Rafael Devers | San Francisco Giants @ Pittsburgh Pirates | 17% | ❌ |
...
| Market | Pick | Line | Price | Score | CLV | Result |
|---|---|---|---|---|---|---|
| Moneyline | Boston Red Sox ML | — | -134 | 9.5 | — | ❌ -1.00u |
| Moneyline | New York Yankees ML | — | -164 | 9.5 | — | ✅ +0.61u |
| Moneyline | Los Angeles Dodgers ML | — | -250 | 9.5 | — | ❌ -1.00u |
| Total | Under 11.5 | 11.5 | -120 | 8.3 | — | ✅ +0.83u |
| Moneyline | Tampa Bay Rays ML | — | -164 | 7.8 | — | ❌ -1.00u |
| Moneyline | Milwaukee Brewers ML | — | -162 | 7.0 | — | ✅ +0.62u |

**Recommended props** (0 of 653 priced cleared the gate)
...
| Player | Mkt | Call | Line | Price | Model | Actual | Result |
|---|---|---|---|---|---|---|---|
| Coby Mayo | Hits | Under | 1.5 | -263 | 88% | 1 | ✅ |
| Jake Mangum | RBI | Under | 0.5 | -261 | 81% | 0 | ✅ |
| Esteury Ruiz | RBI | Under | 0.5 | -379 | 88% | 0 | ✅ |
| Gabriel Moreno | Hits | Over | 0.5 | -259 | 79% | 0 | ❌ |
| Colt Keith | RBI | Under | 0.5 | -278 | 80% | 0 | ✅ |
| William Contreras | Hits | Over | 0.5 | -263 | 78% | 2 | ✅ |
| Freddie Freeman | Hits | Over | 0.5 | -251 | 76% | 2 | ✅ |
| Daulton Varsho | RBI | Under | 0.5 | -255 | 74% | 0 | ✅ |

*Legs: **36-14**. A 50-leg parlay of these would NOT have cashed — every leg must land.*

**NRFI / YRFI forced calls**

| Game | Call | Confidence | Model | Market | Result |
|---|---|---|---|---|---|
| San Diego Padres @ Cincinnati Reds | **NRFI** | High | 66% | 46% | ❌ |
| Athletics @ Texas Rangers | **NRFI** | High | 61% | 51% | ❌ |
| Seattle Mariners @ Boston Red Sox | **YRFI** | High | 57% | 46% | ❌ |
| San Francisco Giants @ Pittsburgh Pirates | **YRFI** | High | 61% | 50% | ✅ |
| Toronto Blue Jays @ Cleveland Guardians | **YRFI** | High | 52% | 41% | ✅ |
| Miami Marlins @ Kansas City Royals | **NRFI** | High | 62% | 51% | ❌ |
| Chicago White Sox @ Houston Astros | **YRFI** | High | 71% | 51% | ❌ |
| New York Yankees @ Los Angeles Angels | **YRFI** | High | 55% | 40% | ❌ |
| Detroit Tigers @ Minnesota Twins | **YRFI** | Medium | 55% | 48% | ❌ |
| Milwaukee Brewers @ Chicago Cubs | **YRFI** | Medium | 54% | 48% | ✅ |
| New York Mets @ Tampa Bay Rays | **YRFI** | Low | 53% | 50% | ✅ |
| St. Louis Cardinals @ Los Angeles Dodgers | **NRFI** | Low | 57% | 54% | ❌ |
| Atlanta Braves @ Washington Nationals | **YRFI** | Coin flip | 50% | 52% | ❌ |
| Baltimore Orioles @ Colorado Rockies | **YRFI** | Coin flip | 51% | 56% | ❌ |
| Philadelphia Phillies @ Arizona Diamondbacks | **YRFI** | Coin flip | 55% | 55% | ❌ |

**HR board — top 10**

| # | Player | Game | P(HR) | Result |
|---|---|---|---|---|
| 1 | Pete Alonso | Baltimore Orioles @ Colorado Rockies | 21% | ❌ |
| 2 | Hunter Goodman | Baltimore Orioles @ Colorado Rockies | 20% | ❌ |
| 3 | Coby Mayo | Baltimore Orioles @ Colorado Rockies | 20% | ❌ |
| 4 | Ty France | San Diego Padres @ Cincinnati Reds | 19% | ✅ |
| 5 | Max Muncy | St. Louis Cardinals @ Los Angeles Dodgers | 19% | ❌ |
| 6 | Samuel Basallo | Baltimore Orioles @ Colorado Rockies | 18% | ❌ |
| 7 | James Wood | Atlanta Braves @ Washington Nationals | 18% | ❌ |
| 9 | Juan Soto | New York Mets @ Tampa Bay Rays | 18% | ✅ |
| 10 | Shohei Ohtani | St. Louis Cardinals @ Los Angeles Dodgers | 18% | ❌ |

*2 homered · model expected 1.7*
...
### Moneyline probability calibration (Model A, n=396)

Brier score: **0.2432** (0.25 = coin flip knowledge; lower is better)
...
- **by market:** Moneyline 231-165 (+2%, CLV -3.6%)  ·  NRFI 6-5 (+1%, CLV -4.0%)  ·  Run Line 42-48 (-2%)  ·  Total 90-92 (-4%, CLV +0.8%)  ·  F5 Total 20-25 (-22%, CLV -2.5%)
- **by side:** Under 64-57 (+2%, CLV +1.5%)  ·  team 299-243 (-1%, CLV -3.4%)  ·  Over 26-35 (-15%, CLV +0.4%)
- **by fav_band:** unknown 20-14 (+12%)  ·  pickem 195-174 (+1%, CLV +0.2%)  ·  fav 120-88 (-6%, CLV -7.1%)  ·  heavy fav 25-13 (-7%, CLV -1.7%)  ·  dog 29-46 (-7%, CLV -1.9%)
